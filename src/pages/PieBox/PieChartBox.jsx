...
const PieChartBox = () => {
  ...
  <LineChart className='bg-blue-500 dark:bg-gray-800 lg:block hidden lg:ms-5 rounded lg:mt-2 mt-10' width={470} height={450} color={green} data={data} margin={{ top: 85, right: 20, bottom: 5, left: 0 }}>
