...
const ChartBoxConversion = (props) => {
    return (
        <main className="lg:hidden border rounded text-white font-serif lg:w-[80%] w-[100%] lg:ms-5 ms-0 lg:mt-0 mt-5">
...
export default ChartBoxConversion